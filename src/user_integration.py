...
class UserIntegration:
    ...
    def create_table(self, user_id):
        ...
        """
        self.cursor.execute(f"CREATE TABLE IF NOT EXISTS {user_id} (user VARCHAR(255) PRIMARY KEY, pass VARCHAR(255), url VARCHAR(255), data_transfer INT, web_suggested_1 VARCHAR(255), web_suggested_2 VARCHAR(255), web_suggested_3 VARCHAR(255), date VARCHAR(255))")
